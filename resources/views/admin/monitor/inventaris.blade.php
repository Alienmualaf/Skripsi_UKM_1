...
@section('title', 'Monitor Aset & Materi')
@section('header', 'Monitoring Aset & Materi')

@section('content')
<div style="margin-bottom: 1.5rem;">
    <h3 style="font-size: 1.25rem; font-weight: 800; color: var(--text-primary); margin: 0 0 0.25rem 0;">Override Data: Inventaris, Peminjaman & Materi</h3>
    <p style="margin: 0; color: var(--text-secondary); font-size: 0.875rem; line-height: 1.5;">Pengawasan seluruh aset inventaris fisik UKM (Keyboard, Standing Mic, Almamater, dll.), rekaman peminjaman barang oleh anggota, dan folder kumpulan materi latihan lagu (Partitur, MP3, Rekaman Latihan).</p>
</div>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($l->loan_letter)
                                <a href="{{ asset('storage/' . $l->loan_letter) }}" target="_blank" class="btn" style="padding: 0.35rem 0.65rem; font-size: 0.75rem; font-weight: 700; background: var(--accent-light); color: var(--accent-color); border-radius: 6px; text-decoration: none; display: inline-flex; align-items: center; gap: 0.2rem;">
