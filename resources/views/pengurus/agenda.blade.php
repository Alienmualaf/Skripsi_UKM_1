...
@section('title', 'Agenda Kegiatan UKM')
@section('header', 'Agenda Kegiatan UKM')
    ...
    <div class="card" style="padding: 1.5rem; border-radius: 16px; border: 1px solid var(--border-color); background: var(--surface-color); display: flex; flex-direction: column; gap: 1.25rem; box-shadow: var(--shadow-sm);">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1rem; border-bottom: 1px solid var(--border-color); padding-bottom: 1rem;">
            <div>
                ...
                <p style="margin: 0.25rem 0 0 0; color: var(--text-secondary); font-size: 0.85rem;">Kelola dan pantau seluruh jadwal latihan, program kerja, dan penampilan.</p>
            </div>
            
            <!-- Quick Management Buttons -->
            <div style="display: flex; align-items: center; flex-wrap: wrap; gap: 0.5rem;">
                <a href="{{ route('pengurus.programs.create') }}" class="btn btn-primary" style="display: inline-flex; align-items: center; gap: 0.35rem; text-decoration: none; padding: 0.55rem 1rem; border-radius: 8px; font-size: 0.825rem; font-weight: 700;">
                    <i class="ph ph-plus" style="font-weight: bold;"></i> Tambah Proker
                </a>
                <a href="{{ route('pengurus.programs.index') }}" class="btn btn-secondary" style="display: inline-flex; align-items: center; gap: 0.35rem; text-decoration: none; padding: 0.55rem 1rem; border-radius: 8px; font-size: 0.825rem; font-weight: 700; border: 1px solid var(--border-color); background: var(--bg-color); color: var(--text-primary);">
                    <i class="ph ph-calendar-blank"></i> Kelola Proker
                </a>
                <a href="{{ route('pengurus.classrooms.index') }}" class="btn btn-secondary" style="display: inline-flex; align-items: center; gap: 0.35rem; text-decoration: none; padding: 0.55rem 1rem; border-radius: 8px; font-size: 0.825rem; font-weight: 700; border: 1px solid var(--border-color); background: var(--bg-color); color: var(--text-primary);">
                    <i class="ph ph-chalkboard"></i> Pusat Kelas
                </a>
            </div>
        </div>
