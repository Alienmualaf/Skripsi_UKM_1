...
<div class="grid-4-stats">
    ...
    <div class="card pengurus-stat-card">
        <div class="pengurus-icon-box" style="background: rgba(59, 130, 246, 0.1); color: #3b82f6;">
    ...
    <div class="card pengurus-stat-card">
        <div class="pengurus-icon-box" style="background: rgba(16, 185, 129, 0.1); color: #10b981;">
    ...
    <div class="card pengurus-stat-card">
        <div class="pengurus-icon-box" style="background: rgba(236, 72, 153, 0.1); color: #ec4899;">
    ...
    <!-- Saldo Kas Saat Ini -->
    <div class="card pengurus-stat-card">
        <div class="pengurus-icon-box" style="background: rgba(139, 92, 246, 0.1); color: #8b5cf6;">
