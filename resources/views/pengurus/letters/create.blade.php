    ...
    <form action="{{ route('pengurus.letters.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group mb-4">
            ...
            <select name="type" class="form-control" required style="padding: 0.65rem;">
                ...
                <option value="Surat Tugas" {{ old('type') === 'Surat Tugas' ? 'selected' : '' }}>Surat Tugas</option>
                <option value="Surat Permohonan" {{ old('type') === 'Surat Permohonan' ? 'selected' : '' }}>Surat Permohonan</option>
                <option value="Surat Undangan" {{ old('type') === 'Surat Undangan' ? 'selected' : '' }}>Surat Undangan</option>
                <option value="Surat Peminjaman" {{ old('type') === 'Surat Peminjaman' ? 'selected' : '' }}>Surat Peminjaman</option>
                <option value="Surat Keterangan" {{ old('type') === 'Surat Keterangan' ? 'selected' : '' }}>Surat Keterangan</option>
            </select>
