...
<body class="bg-white text-navy-800 font-sans antialiased min-h-screen">
    ...
    <main class="max-w-4xl mx-auto py-20 px-6">
        <div class="text-center mb-16">
            <span class="text-[10px] font-black text-gold-500 uppercase tracking-[0.2em]">PROFIL RESMI</span>
            <h1 class="font-serif font-normal text-4xl sm:text-5xl text-navy-900 mt-3 mb-6">Tentang {{ $profile->name }}</h1>
            <div class="w-16 h-1 bg-gold-500 mx-auto rounded-full"></div>
        </div>
        
        <!-- Box Layout with Gold border-l from design.md -->
        <div class="bg-white border border-slate-100 border-l-[6px] border-l-gold-500 rounded-r-3xl p-8 md:p-12 shadow-xl hover:shadow-2xl transition-all duration-300">
            <div class="prose max-w-none text-slate-700 leading-relaxed font-sans text-base sm:text-lg space-y-6">
