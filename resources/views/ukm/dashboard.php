...
<div class="grid-4-stats">
    <!-- Total Anggota Aktif -->
    <div class="card ukm-stat-card">
        <div class="ukm-icon-box" style="background: rgba(59, 130, 246, 0.1); color: #3b82f6;">
    ...
    <div class="card ukm-stat-card">
        <div class="ukm-icon-box" style="background: rgba(16, 185, 129, 0.1); color: #10b981;">
    ...
    <!-- Total Penampilan -->
    <div class="card ukm-stat-card">
        <div class="ukm-icon-box" style="background: rgba(236, 72, 153, 0.1); color: #ec4899;">
    ...
    <!-- Saldo Kas Saat Ini -->
    <div class="card ukm-stat-card">
        <div class="ukm-icon-box" style="background: rgba(139, 92, 246, 0.1); color: #8b5cf6;">
        ...
        <div>
            ...
            <div style="font-size: 1.5rem; font-weight: 800; color: var(--success-color); margin-top: 0.15rem;">Rp{{ number_format($netBalance, 0, ',', '.') }}</div>
        </div>
    </div>
</div>
            ...
            @forelse($announcements as $announce)
                <div style="padding: 1rem; background: var(--bg-color); border-radius: 10px; border: 1px solid var(--border-color); transition: border-color 0.2s;" onmouseover="this.style.borderColor='var(--accent-color)'" onmouseout="this.style.borderColor='var(--border-color)'">
                    ...
                    <div style="font-size: 0.75rem; color: var(--text-muted); margin-top: 0.75rem; display: flex; justify-content: space-between;">
                        <span>Oleh: {{ $announce->creator ? $announce->creator->name : 'Admin UKM' }}</span>
