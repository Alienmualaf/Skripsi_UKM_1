...
<div class="card" style="max-width: 600px; padding: 2rem;">
    ...
    <form action="{{ route('ukm.trainers.update', $trainer->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="flex gap-2 mt-6">
            ...
            <a href="{{ route('ukm.trainers.index') }}" class="btn" style="background: var(--bg-color); border: 1px solid var(--border-color); padding: 0.65rem 1.25rem; font-weight: 700;">Batal</a>
        </div>
    </form>
</div>
@endsection
