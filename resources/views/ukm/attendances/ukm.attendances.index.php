...
<div class="card animate-fade-in">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 1.5rem;">
        ...
        <div class="card animate-fade-in" style="border: 1px solid var(--border-color); padding: 1.25rem; transition: all 0.2s; border-radius: 16px; box-shadow: 0 4px 6px rgba(0,0,0,0.015); margin-bottom: 0;">
